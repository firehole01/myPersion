...
## 三、安装kubeadm,kubectl,kubelet(所有节点执行)

#### 3.1 创建kubernetes的repo
...
因为gcr.io被墙，所以通过kubeadm引导安装的时候无法正确下载到需要的镜像，所以要提前下载；
